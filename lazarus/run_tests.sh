...
test_cw_tone test_cw_leading test_replay test_psk_varicode test_psk test_spectrum test_noise test_waterfall test_portfolio test_fec test_mfsk_varicode test_mfsk_tones test_mfsk_sync test_mfsk_modem test_olivia_block test_olivia_tones test_olivia_sync test_olivia_modem test_afc test_reception_state test_adaptive_squelch test_regression"
