...
test_cw_tone test_cw_leading test_replay test_psk_varicode test_psk test_spectrum test_waterfall test_portfolio test_fec test_mfsk_varicode test_regression"
