...
要求 70 件 (検証済 51 / 実装済 1 / 方針決定 3 / 起案 7 / 後送り 8)
...
| OLV-002 | Olivia/Contestiaの送受信が成立する | Communicate | A | Y | X | No | Must | Olivia モデムの往復試験と test_regression への追加 (ブロックの頭出しが要る) | 起案 |  | §12 Phase 2 Olivia/Contestia |  |
